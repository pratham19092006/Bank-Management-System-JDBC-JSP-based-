                ...
                if (rs.next()) {
                    ...
                    if (currentBalance >= amount) {
                        ...
                        if (rows > 0) {
                            ...
                            message = "Success: $" + amount + " withdrawn from account " + accNumber + ". New balance: $" + newBalance;
                        }
                    } else {
                        message = "Error: Insufficient balance! Current balance: $" + currentBalance;
                    }
                } else {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Withdraw funds from customer account securely</p>
        </div>
        
        <div class="warning-note">
            ⚠️ Note: Withdrawal will be denied if insufficient balance
        </div>
